                        ...
                        foreach (var m in eventtype.Methods)
                        {
                            if (m.Name == "Invoke")
                            {
                                ...
                                foreach (var src in m.Parameters)
                                {
                                    ...
                                    this.paramtypes.Add(new QurasParam(src.Name, paramtype));
            ...
            if (method != null)
            {
                ...
                if (method.HasParameters)
                {
                    ...
                    foreach (var p in method.Parameters)
                    {
                        ...
                        this.paramtypes.Add(new QurasParam(p.Name, paramtype));
                    }
                }
                if (method.HasBody)
                {
                    ...
                    if (bodyNative.HasVariables)
                    {
                        foreach (var v in bodyNative.Variables)
                        {
                            ...
                            this.body_Variables.Add(new QurasParam(indexname, v.VariableType.FullName));
                        }
                    }
