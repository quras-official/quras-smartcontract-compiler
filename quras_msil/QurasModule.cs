...
namespace Quras.Compiler
{
    public class QurasModule
    {
        public QurasModule(ILogger logger)
        {
            this.logger = logger;
        }
        ILogger logger;
        //小蚁没类型，只有方法
        public SortedDictionary<int, QurasCode> total_Codes = new SortedDictionary<int, QurasCode>();
        public byte[] Build()
        {
        ...
        public string GenJson()
        {
            ...
            json["__name__"] = new MyJson.JsonNode_ValueString("QurasModule.");
    ...
    public class NeoMethod
    {
        ...
        public List<QurasParam> paramtypes = new List<QurasParam>();
        public string returntype;
        public bool isPublic = true;
        public bool inSmartContract;
        //临时变量
        public List<QurasParam> body_Variables = new List<QurasParam>();

        //临时记录在此，会合并到一起
        public SortedDictionary<int, QurasCode> body_Codes = new SortedDictionary<int, QurasCode>();
        public int funcaddr;
    ...
    {
        public QurasParam(string name, string type)
        {
            this.name = name;
            this.type = type;
        }
